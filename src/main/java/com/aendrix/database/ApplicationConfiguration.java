...
@EnableJpaRepositories(
        basePackages = "com.aendrix.entities.application",
...
public class ApplicationConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean applicationEntityManager() {
        ...
        em.setPackagesToScan("com.aendrix.entities.application");
    ...
    @ConfigurationProperties(prefix="app.datasource.ae-hub")
